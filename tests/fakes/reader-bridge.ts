 ...
 */
type BridgeConstructor = typeof IframeReaderBridge;
...
export function createReaderBridgeHarness(
    ...
    const bridge = new BridgeCtor(
        ...
        isLocal,
        (attachment ?? undefined) as ConstructorParameters<BridgeConstructor>[2],
        localAttachment as ConstructorParameters<BridgeConstructor>[3],
        localDataManager as ConstructorParameters<BridgeConstructor>[4],
    );
