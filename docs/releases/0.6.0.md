...
- New **[Conversion Pipeline](../convert-pipeline.md)** — Technical reference for the HTML ↔ Markdown conversion system, including supported elements, round-trip guarantees, and extension points.
